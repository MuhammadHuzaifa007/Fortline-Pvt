...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      { source: "/admissions", destination: "/dashboard", permanent: false },
      { source: "/admissions/:path*", destination: "/dashboard", permanent: false },
      { source: "/pipelines", destination: "/dashboard", permanent: false },
      { source: "/pipelines/:path*", destination: "/dashboard", permanent: false },
      { source: "/broadcasts", destination: "/dashboard", permanent: false },
      { source: "/broadcasts/:path*", destination: "/dashboard", permanent: false },
      { source: "/automations", destination: "/dashboard", permanent: false },
      { source: "/automations/:path*", destination: "/dashboard", permanent: false },
      { source: "/flows", destination: "/dashboard", permanent: false },
      { source: "/flows/:path*", destination: "/dashboard", permanent: false },
      { source: "/agents", destination: "/dashboard", permanent: false },
      { source: "/agents/:path*", destination: "/dashboard", permanent: false },
      { source: "/ai-agents", destination: "/dashboard", permanent: false },
      { source: "/ai-agents/:path*", destination: "/dashboard", permanent: false },
    ];
  },
};
