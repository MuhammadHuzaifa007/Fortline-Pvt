...
function InboxPageInner() {
  ...
  /**
   * `?c=<id>` or `?conversation_id=<id>` deep-link support.
   */
  const deepLinkConvId = searchParams.get("c") || searchParams.get("conversation_id");
  const salesMemberParam = searchParams.get("sales_member_id");
  ...
  const [selectedSalesMemberId, setSelectedSalesMemberId] = useState<string | null>(
    salesMemberParam || null
  );
  ...
  useEffect(() => {
    if (salesMemberParam) {
      setSelectedSalesMemberId(salesMemberParam);
    }
  }, [salesMemberParam]);
  /**
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 min-w-0 max-w-[170px] xs:max-w-[220px] sm:max-w-[320px]">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setSelectedSalesMemberId(val);
                const params = new URLSearchParams(searchParams.toString());
                if (val) {
                  params.set("sales_member_id", val);
                } else {
                  params.delete("sales_member_id");
                }
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden w-full">
        ...
        >
          <ConversationList
            ...
            selectedSalesMemberId={selectedSalesMemberId}
            onSalesMemberChange={setSelectedSalesMemberId}
