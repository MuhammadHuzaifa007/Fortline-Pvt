...
export const metadata: Metadata = {
  title: {
    default: "Fortline-Pvt CRM",
    template: "%s — Fortline-Pvt CRM",
  },
  description: "Fortline-Pvt Executive Sales Operations CRM — WhatsApp monitoring and SLA tracking for 30 sales representatives across enterprise IT divisions.",
  robots: {
    index: false,
    follow: false,
  },
