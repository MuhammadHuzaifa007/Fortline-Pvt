...
describe("middleware — refreshed auth cookies survive redirects", () => {
  ...
  it("redirects unauthenticated user accessing protected modules (/dashboard, /inbox, /notifications, /contacts, /settings)", async () => {
    mockUser = null;

    const routes = ["/dashboard", "/inbox", "/notifications", "/contacts", "/settings"];
  ...
  it("redirects obsolete routes (/flows, /ai-agents, /admissions) to /dashboard", async () => {
    const obsoleteRoutes = ["/flows", "/ai-agents", "/admissions"];
